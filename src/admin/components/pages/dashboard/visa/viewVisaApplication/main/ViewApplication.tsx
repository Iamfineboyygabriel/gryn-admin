        ...
        <div>
          <nav className="mt-[1.5em]">
            <div className="flex items-center border-b-[3px] border-gray-100 text-base font-semibold">
              ...
              <button.PrimaryButton
                ...
                className="ml-[3em] items-center gap-2 hidden lg:flex rounded-full bg-primary-200 px-[1.5em] py-[8px] font-medium text-white transition-colors duration-300 hover:bg-primary-700 hover:text-white disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
          ...
          <section className="mt-8">
            ...
            <div
              ...
              style={{
                display: activeLink === "destinationDetails" ? "block" : "none",
              }}
            >
