...
const DeletePendingModal = ({ onConfirm, onCancel, selectedCount }: any) => {
  return (
      ...
      <div className="m-auto w-[24em] py-[2em] text-center">
        ...
        <header className="mt-[2em] flex flex-col">
          <h1 className="text-xl whitespace-nowrap font-semibold">
            Are you sure you want to delete pending Agent ?
          </h1>
        </header>
        <article>
          <div className="mt-1 text-sm font-light text-center flex flex-col gap-[5px] tracking-wide text-grey">
            <p className="text-gray-600 mb-6">
              Are you sure you want to delete {selectedCount} selected pending
              agent {selectedCount === 1 ? "member" : "members"}? This action
              cannot be undone.
            </p>
          </div>
        </article>
