...
import {
  approveAgent,
  rejectAgent,
} from "../../../../../../../../shared/redux/shared/services/shareApplication.services";
    ...
    <main className="font-outfit">
      ...
      <PrivateElement feature="ALL_USERS" page="Submit Response">
        <button.PrimaryButton
          className="m-auto mt-[5em] w-[40%] lg:w-[18%] gap-2 rounded-full bg-linear-gradient py-[12px] text-center text-lg font-medium text-white"
