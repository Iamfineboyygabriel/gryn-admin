...
// const Drafts = () => {
//   const { allUserDraftedNews, fetchNews, currentPage, loading, searchTerm, updateSearchTerm } = useAllDraftedNews();
...
//             </div>
//             <div>
//               <img src={deleteImg} alt="delete_img" />
//             </div>
//             </div>
//           </div>
//         ))
...
const Drafts = () => {
  ...
  const handleEditDraft = (draft: any) => {
    navigate('/admin/dashboard/news/create_news', { state: { draftData: draft } });
  };
