  ...
  return (
    <main className="font-outfit">
      ...
      <div className="mt-[1em] h-auto w-full overflow-auto rounded-lg bg-white px-[2em] py-3 pb-[10em] dark:bg-gray-800">
        ...
        <h2 className="text-xl mt-[1em] font-semibold">Create News</h2>
        <form className="mt-[2em] w-full lg:w-[50%]">
          <div className="flex flex-col gap-[1.5em]">
            <div className="w-full">
              ...
              <input
                ...
                required
              />
              <p className="text-pink-primary font-medium mt-2">
                {topic.length}/1000
              </p>
            </div>
        ...
        <div className="flex mt-[7em] gap-3 w-[70%] lg:w-[50%] justify-between items-center">
          <button.PrimaryButton
            onClick={submitDraft}
            className="rounded-full w-[55%] lg:w-[45%] bg-purple-pink py-[12px] text-center text-lg font-semibold text-pink-primary"
          >
            {draftLoading ? (
              <ReactLoading
                color="#FFFFFF"
