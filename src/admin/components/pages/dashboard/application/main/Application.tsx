          ...
          <div className="flex gap-[1em]">
            <PrivateElement feature="APPLICATION" page="Direct Application">
              <button.PrimaryButton
                ...
                className="flex gap-2 bg-approve rounded-full px-[1.5em] py-[8px] font-medium text-white"
              >
            ...
            <PrivateElement feature="APPLICATION" page="Update Application">
              <button.PrimaryButton
                ...
                className="flex gap-2 bg-pink-primary rounded-full px-[1.5em] py-[8px] font-medium text-white"
              >
                <img src={plus} alt="cross" />
                Update Application
              </button.PrimaryButton>
