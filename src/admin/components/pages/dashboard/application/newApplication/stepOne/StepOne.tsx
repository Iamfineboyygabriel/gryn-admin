    ...
    setTimeout(() => {
      const body = {
        ...
        dateOfBirth: dateOfBirth
          ? formatDateApplication(new Date(dateOfBirth))
          : null,
        email,
        address,
        phoneNumber,
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 md:gap-5 lg:gap-[2em]">
          <div className="w-full">
            ...
            <input
              ...
              className="border-border focus:border-border mt-3 md:mt-[1em] w-full rounded-lg border-[1px] bg-inherit p-3 focus:outline-none"
            />
          </div>
          <div className="w-full">
