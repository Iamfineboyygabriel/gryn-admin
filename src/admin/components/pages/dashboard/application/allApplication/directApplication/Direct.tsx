...
// import { useAllDirectApplication } from "../../../../../../../shared/redux/hooks/admin/getAdminProfile";
...
// console.log("isdirect",applications)
...
//               item?.isDirect === "SUBMITTED" ? "bg-yellow-500" : 
//               item?.isDirect === "COMPLETED" ? "bg-green-500" :
//               "bg-red-500"
//             }`}
//           >
...
//               className="bg-gray-100 px-3 py-2 rounded text-sm cursor-pointer"
//               value={isDirect}
//               onChange={(e) => handleIsDirectChange(e.target.value)}
//             >
    ...
    return applications?.map((item: any, index: number) => (
      ...
      >
        ...
        <td className="flex items-center whitespace-nowrap px-6 py-4">
          <button
            className={`mr-2 rounded-full px-3 py-2 text-white ${
              item?.isDirect === "PENDING" ? "bg-yellow-500" : 
              item?.isDirect === "APPROVED" ? "bg-green-500" :
              "bg-red-500"
            }`}
          >
            {item?.isDirect === "PENDING" ? "In Progress" : 
             item?.isDirect === "APPROVED" ? "Completed" :
             "Declined"}
          </button>
          <button
            onClick={() => handleViewDetails(item?.id)}
