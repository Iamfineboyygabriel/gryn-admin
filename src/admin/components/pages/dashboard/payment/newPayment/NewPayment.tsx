...
import { createInvoice } from "../../../../../../shared/redux/shared/slices/shareApplication.slices";
...
const NewPayment = () => {
  ...
  return (
    <main className="font-outfit">
      <h1 className="text-2xl font-bold dark:text-white">New Payments</h1>
      <div className="mt-[1em] h-auto w-full overflow-auto rounded-lg bg-white px-[2em] py-3 pb-[10em] dark:bg-gray-800">
        ...
        <h1 className="font-semibold text-2xl">New Payment</h1>
