                ...
                <div className="flex-1">
                  ...
                  >
                   ...
                   <input
                    ...
                    required
                 //   disabled={loading}
               className="border-border focus:border-border mt-[3px] w-[13em] rounded-lg border-[1px] bg-inherit p-3 focus:outline-none"
               />
                </div>
                <div className="flex-1">
                  <label
                  ...
                  <input
                    ...
                    className="border-border w-[200px] focus:border-border mt-1 rounded-lg border-[1px] bg-inherit p-3 focus:outline-none"
                  />
                </div>
              </div>
              <div>
