...
const NewInvoice = () => {
  const { staffEmail } = useParams<{ staffEmail: string }>();
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="font-medium dark:text-gray-700">
                All Staffs /
                <span className="m-2 font-medium">View Details</span> /
            ...
            <div className="flex flex-col gap-[1em]">
              ...
              <div className="flex-1">
                ...
                <input
                  ...
                  value={staffEmail}
                  readOnly
                  className="border-border rounded-lg border-[1px] bg-inherit p-3 focus:outline-none bg-gray-100 w-full"
                />
              </div>
            </div>
