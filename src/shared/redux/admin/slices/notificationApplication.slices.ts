...
export const getAllNews = createAsyncThunk(
  ...
  async ({
    ...
    const response = await notificationApplicationServices.getAllNews(
      page,
      limit,
      search
    );
...
export const getAllDraftedNews = createAsyncThunk(
  ...
  async ({
    ...
    const response = await notificationApplicationServices.getAllDraftedNews(
      page,
      limit,
      search
    );
...
export const CreateNotification = createAsyncThunk(
  ...
  async ({ body, userId }: { body: any; userId: any }, thunkAPI) => {
    try {
      const data = await notificationApplicationServices.CreateNotification(
        userId,
        body
      );
      return data;
...
export const getAllNotification = createAsyncThunk(
  ...
  async ({ page, limit }: { page: number; limit: number }) => {
    const response = await notificationApplicationServices.getAllNotification(
      page,
      limit
    );
    return {
...
export const updateNotificationStatus = createAsyncThunk(
  ...
  async (notificationId: string, thunkAPI) => {
    try {
      const response =
        await notificationApplicationServices.updateNotificationStatus(
          notificationId
        );
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(createNewsDrafs.rejected, (state, action) => {
        ...
        const errorMessage =
          action.error.message || "News drafts creation failed.";
        setMessage(errorMessage);
      })
...
export const { setAllNewsSearchTerm, setAllDraftedNewsSearchTerm } =
