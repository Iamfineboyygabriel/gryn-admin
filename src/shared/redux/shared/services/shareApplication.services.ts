...
const API_URL_CREATE_INVOICE_PAYMENT_STAFF =
  process.env.REACT_APP_API_URL + "/invoice/payment";
...
const API_URL_CREATE_STUDENT =
  process.env.REACT_APP_API_URL + "/admin/users/student";

const API_URL_CREATE_STAFF =
  process.env.REACT_APP_API_URL + "/admin/users/staff";

const API_URL_CREATE_ADMIN =
  process.env.REACT_APP_API_URL + "/admin/users/admin";

const API_URL_UPDATE_ROLE = process.env.REACT_APP_API_URL + "/admin/users/role";

const API_URL_CREATE_AGENT =
  process.env.REACT_APP_API_URL + "/admin/users/agent";

const API_URL_FINDSTUDENTBY_EMAIL_UNIVERSITY_DEGREE =
  process.env.REACT_APP_API_URL +
  "/admin/application/byNameUniversityAndDegree";
...
export const updateDirectApplication = async (id: string, body: any) => {
...
const getAllAgents = async (
  ...
  const url = `${
    process.env.REACT_APP_API_URL
  }/admin/users/agents?page=${page}&limit=${limit}&search=${encodeURIComponent(
    search
  )}`;
  try {
    const response = await axios({
...
const createInvoicePaymentForStaff = async (body: any) => {
  try {
    ...
    const response = await axios.post(
      API_URL_CREATE_INVOICE_PAYMENT_STAFF,
      body,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
...
const getAllVisaApplication = async (
  page: number,
  limit: number,
  search: string = ""
) => {
  const url = `${
    process.env.REACT_APP_API_URL
  }/visa?page=${page}&limit=${limit}&search=${encodeURIComponent(search)}`;
  try {
    const response = await axios({
      url,
      headers: authHeader(),
...
const getAllPendingAgents = async (
  ...
  const url = `${
    process.env.REACT_APP_API_URL
  }/admin/users/pending/agents?page=${page}&limit=${limit}&search=${encodeURIComponent(
    search
  )}`;
  try {
    const response = await axios({
...
const updateStudentCreated = async (
...
const findStudentByEmailUniversityDegree = async (body: any) => {
  try {
    const token = sessionStorage.getItem("userData");
    const response = await axios.post(
      API_URL_FINDSTUDENTBY_EMAIL_UNIVERSITY_DEGREE,
      body,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
...
export const updateStaff = async (id: string, body: UpdateStaff) => {
...
export async function uploadVisaApplicationDocument(
  endpoint: string,
  body: FormData
) {
  const url = `${process.env.REACT_APP_API_URL}${endpoint}`;
...
const getAllApplicationPayment = async (
  page: number,
  limit: number,
  search: string = ""
) => {
  const url = `${
    process.env.REACT_APP_API_URL
  }/admin/application/payment?page=${page}&limit=${limit}&search=${encodeURIComponent(
    search
  )}`;
  try {
    const response = await axios({
