...
import { budgetUploadPaymentDocument } from "../redux/shared/slices/shareApplication.slices";

const BudgetPaymentReceiptResponse = ({ budgetId }: any) => {
...
export default BudgetPaymentReceiptResponse;
