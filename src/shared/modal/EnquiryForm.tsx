...
//   return (
//     <main
//       className={`fixed font-outfit inset-y-0 right-0 w-[500px] bg-white shadow-lg transform  transition-transform duration-300 ease-in-out`}
//     >
...
const EnquiryForm = ({ onClose }: any) => {
  ...
  const handleCopyLink = async () => {
    try {
      // You can replace this with your actual link
