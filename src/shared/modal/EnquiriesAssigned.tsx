...
const EnquiriesAssigned = ({ onClose }: any) => {
  return (
    <main className="px-[5em] font-outfit">
      <div className="m-auto w-[24em] py-[2em] text-center">
        ...
        <header className="mt-[2em] flex flex-col">
          <h1 className="text-2xl font-semibold">Staff assigned</h1>
        </header>
        <article>
          <div className="mt-[1em] text-sm font-light text-center flex flex-col gap-[5px] tracking-wide text-grey">
            <p>you have assigned an enquiry to staff</p>
          </div>
        </article>
        <Link to="/admin/dashboard/instagram">
...
export default EnquiriesAssigned;
