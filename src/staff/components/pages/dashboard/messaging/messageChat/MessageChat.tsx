...
//       const hasUnreadMessages = currentChat.messages?.some(
//         (msg: Message) => !msg.read && msg.senderId !== currentUserId
//       );

//       if (hasUnreadMessages) {
//         const updateReadStatusAndCount = async () => {
//           await dispatch(updateReadStatus({ chatId: currentChat.id }));
//           dispatch(fetchUnreadCount());
//         };
//         updateReadStatusAndCount();
//       }
//     }
