...
//   useEffect(() => {
//     socketService.on("receiveMessage", (newMessage: any) => {
//       setLocalChats((prevChats: any) => {
//         return prevChats
//           .map((chat: any) => {
...
//   return (
//     <main className="h-screen w-full max-w-md overflow-y-auto rounded-xl bg-white p-4 font-outfit">
//       <section ref={searchRef} className="relative w-full">
//         <input
//           type="text"
//           className="w-full rounded-full bg-gray-100 py-2 pl-4 pr-12 text-sm"
//           placeholder="Search users by email"
//           value={localSearch}
//           onChange={handleSearchChange}
//           onFocus={() => setShowSuggestions(true)}
...
//               const otherUser = getOtherUser(chat);
//               const lastMessage = chat?.messages[chat?.messages?.length - 1];
//               const localUnreadCount = chat?.messages.filter(
...
//                 <div
//                   key={chat.id}
//                   className={`flex cursor-pointer gap-2 rounded-lg p-2 hover:bg-gray-50 ${
//                     selectedChatId === chat.id
//                       ? "bg-gray-100 dark:bg-gray-700"
//                       : ""
//                   }`}
